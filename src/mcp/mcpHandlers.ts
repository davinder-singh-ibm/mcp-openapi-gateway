...
import { ToolInvocation } from '../config/types.js';
...
export class MCPHandlers {
  ...
  async handleToolsList(): Promise<MCPToolsListResponse> {
  ...
  ): Promise<{ response?: MCPCallToolResponse; error?: MCPErrorObject }> {
