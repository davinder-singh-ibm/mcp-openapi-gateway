...
export function loadConfig() {
    ...
    const serviceNameMode = (process.env.SERVICE_NAME_MODE || 'title');
...
export function loadSwaggerConfigs() {
    ...
    switch (authType) {
        ...
        case 'oauth2_client_credentials': {
            ...
            if (!tokenUrl || !clientId || !clientSecret) {
                throw new Error(`OAuth2 requires OAUTH2_TOKEN_URL, OAUTH2_CLIENT_ID, and OAUTH2_CLIENT_SECRET`);
            }
            return {
